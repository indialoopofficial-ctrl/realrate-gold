...
export default function App() {
  ...
  return <div className="site-shell">
    ...
    <header className="header glass">
      ...
      <nav className="desktop-nav"><a href="#rates">Rates</a><a href="#calculator">Calculators</a><a href="#learn">Learn</a><a href="#faq">FAQ</a><a href="/about/">About</a></nav>
    ...
    {mobileOpen && <nav className="mobile-nav glass"><a href="#rates" onClick={()=>setMobileOpen(false)}>Rates</a><a href="#calculator" onClick={()=>setMobileOpen(false)}>Calculators</a><a href="#learn" onClick={()=>setMobileOpen(false)}>Learn</a><a href="#faq" onClick={()=>setMobileOpen(false)}>FAQ</a><a href="/about/" onClick={()=>setMobileOpen(false)}>About</a></nav>}
    ...
    <footer className="footer section-pad"><div className="footer-brand"><a className="brand" href="#top"><span className="brand-mark">R</span><span><b>RealRate</b><small>Gold & Silver</small></span></a><p>Aaj ka gold rate, selling price aur jewellery calculations — India ke liye simple aur transparent.</p></div><div className="footer-links"><div><b>Today rates</b><a href="/24k-gold-rate/">24K gold rate today</a><a href="/22k-gold-rate/">22K / 916 gold rate today</a><a href="/18k-gold-rate/">18K gold rate today</a><a href="/silver-rate/">Silver rate today</a><a href="/gold-selling-price-today/">Gold selling price today</a></div><div><b>Calculators</b><a href="/gold-calculator/">Gold calculator</a><a href="/jewellery-bill-calculator/">Jewellery bill calculator</a><a href="/old-gold-calculator/">Old gold calculator</a><a href="/gold-purity-calculator/">Gold purity calculator</a></div><div><b>Trust & legal</b><a href="/about/">About RealRate</a><a href="/methodology/">How rates work</a><a href="/contact/">Contact</a><a href="/privacy-policy/">Privacy Policy</a><a href="/terms/">Terms</a><a href="/disclaimer/">Disclaimer</a></div></div><div className="footer-bottom"><span>© {new Date().getFullYear()} RealRate</span><span>For informational estimates only · Verify final trade price locally.</span></div></footer>
  </div>;
}
